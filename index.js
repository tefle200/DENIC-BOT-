...
⭐ *GitHub:* github.com/novaxmd/NOVA-XMD`;
    conn.sendMessage(conn.user.id, { image: { url: `https://github.com/novaxmd/BMB-XMD-DATA/raw/refs/heads/main/image/heroku.jpg` }, caption: up })
  }
  })
...
if (isBanned) return; // Ignore banned users completely
  ...
  const ownerFile = JSON.parse(fs.readFileSync('./lib/sudo.json', 'utf-8'));  // 𝐸𝑅𝐹𝒜𝒩 𝒜𝐻𝑀𝒜𝒟 
